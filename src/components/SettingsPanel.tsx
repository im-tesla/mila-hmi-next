...
const icons = {
  Controls: <Gamepad2 size={24} strokeWidth={2} />,
  Navigation: <Navigation size={24} strokeWidth={2} />,
  Locks: <Lock size={24} strokeWidth={2} />,
  Lights: <Sun size={24} strokeWidth={2} />,
  Display: <Monitor size={24} strokeWidth={2} />,
  Software: <Code2 size={24} strokeWidth={2} />,
};
